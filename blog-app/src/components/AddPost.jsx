...
function AddPost() {
   ...
   const submitPost = (event) => {
      ...
      createPost(post,user).then(response => {
  ...
  return (
    ...
    <Container>
       <Card>
         <CardHeader><h1>What's going in your mind ?</h1></CardHeader>
         <CardBody>
            <Form onSubmit={submitPost}>
               ...
               <Container className='text-center'>
                  ...
                  <Button onClick={reset} className='ms-3' color='danger'>Reset Content</Button>
               </Container>
            </Form>
         </CardBody>
       </Card>
